...
AC_FL_RunContent( 'codebase','http://fpdownload.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=8,0,0,0','width','800','height','50','hspace','0','vspace','0','align','middle','src','images/top','quality','high','bgcolor','#ffffff','allowscriptaccess','sameDomain','pluginspage','http://www.macromedia.com/go/getflashplayer','movie','top' ); //end AC code
		...
		<table border='0' cellpadding='0' cellspacing='0' align="center">
          ...
          <tr>
            ...
            <td align='left' valign='top' bgcolor='396bff'><p align="center" class='style10'>
              <?php
			  
$con = mysql_query("SELECT * FROM descargas ORDER BY id_descarga ASC", $link); //Consulta de las modalidades
			  
	while($row = mysql_fetch_array($con)) //Mientras haya datos...
    { 
	$id = $row['id_descarga'];
	}	  	
	$id +=1;
	
	mysql_query("INSERT INTO descargas VALUES ($id, '$titulo', '$descripcion', '$fichero', NOW())", $link);
		
	echo "<meta http-equiv='refresh' content='3;URL=descargas.php'>";
echo "La descarga se ha sido publicado con &eacute;xito.";
		?>
            </td>
