        ...
        <tr>
          <td><table id="Table_01" width="800" height="100" border="0" cellpadding="0" cellspacing="0">
              ...
              <tr>
                ...
                <td rowspan="2"><a href="contacto.php"><img src="images/menucabecera_12.jpg" alt="" width="18" height="70" border="0"></a></td>
              </tr>
              <tr>
...
echo "Su descarga ha sido modificada con éxito.";
}

$actualiza = mysql_query("UPDATE descargas SET titulo = '$titulo', descripcion = '$descripcion', nombre_fichero = '$fichero', fecha_insercion = NOW()", $link);
					 if (!$actualiza) {
