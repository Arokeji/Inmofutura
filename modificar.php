	...
	<tr>
	  <td height='19' background='images/backindex_04.jpg'>	  </td>
		<td align='left' valign='top' bgcolor='396bff'><div align="center">
		  <form name="anuncio" method="post" action="modificar2.php">
		    <table width="420" border="0">
			<strong class='style10'>Modificar anuncio: <? echo $ide; ?></strong>
				<br>
              <tr>
			  ...
			  $identificador = mysql_query("SELECT * FROM inmueble WHERE id_inmueble=$ide", $link);
				 while($row2 = mysql_fetch_array($identificador)) //Mientras haya datos...
      		   { 
		 		$direccion = $row2['direccion'];
				$metros2 = $row2['n_metros'];
				$otros = $row2['otros'];
				$telefono = $row2['telefono'];
				$hora_contacto = $row2['hora_contacto'];
				$email = $row2['email'];
				$precio = $row2['precio'];
			  	}
			  ...
			  <tr>
				...
				<td><input name="direccion" type="text" size="30" maxlength="30" value="<? echo $direccion;?>">				</td>
			  </tr>
              <tr>
              ...
              <tr>
                ...
                <td><label>
                  <input name="metros" type="text" size="4" maxlength="4" value="<? echo $metros2;?>">
                </label></td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td><label>
                  <input name="otros" type="text" size="30" maxlength="30" value="<? echo $otros;?>">
                </label></td>
              </tr>
              <tr>
                <td><p class='style10'><strong>Telefono:</strong></td>
                <td><input name="telefono" type="text" size="9" maxlength="9" value="<? echo $telefono;?>"></td>
              </tr>
              <tr>
                <td><p class='style10'><strong>Hora de contacto:</strong></td>
                <td><input name="horadecontacto" type="text" size="30" maxlength="30" value="<? echo $hora_contacto;?>">
                </td>
              </tr>
              <tr>
                <td><p class='style10'><strong>Email:</strong></td>
                <td><input name="email" type="text" size="40" maxlength="40" value="<? echo $email;?>"></td>
              </tr>
              <tr>
                <td><p class='style10'><strong>Precio final:</strong></td>
                <td><p class='style10'>
                  <input name="precio" type="text" size="12" maxlength="12" value="<? echo $precio;?>">
