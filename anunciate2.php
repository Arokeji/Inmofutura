...
echo "Su anuncio ha sido publicado con éxito.";
}

$result = mysql_query("SELECT * FROM inmueble ORDER BY id_inmueble ASC", $link); //Consulta de las modalidades
...
mysql_query("INSERT INTO inmueble VALUES ($id,'$direccion',$metros,$habitaciones,$banos,'$estado',$planta,'$ascensor','$otros',$telefono,'$email','$horadecontacto',
			NOW(),$tipo,$modalidad,$zona,$precio)", $link);
mysql_close ($link);
		?>
